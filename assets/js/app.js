...
/**2:09:30 search toggle for mobile device */
...
addEventOnElements(searchTooglers, "click", toggleSearch);
    ...
    if (searchField.value){
       ...
       fetchData(url.geo(searchField.value), function(locations) {
        ...
        for (const { name, lat, lon, country, state } of locations ) {
            ...
            searchResult.querySelector("[data-search-list]").appendChild
            (searchItem);
...
/**
 * render all weather data in html page which kinda cool hehehe
   ...
   card.innerHTML = `
    <h2 class="title-2 card-title">Now</h2>
        ...
        <div class="wrapper">
                ...
                width="64" height="64" alt="${description}" class="weather_icon">
        </div>
